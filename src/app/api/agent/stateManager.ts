...
export function deriveUIHint(state: ConversationState): any {
  const hasRequiredInfo = REQUIRED_INFO.some(
...
export function updateStateFromUserInput(
  ...
  switch (currentQuestion) {
    ...
    case 'move_in_date':
      ...
      break;
    case 'over_20':
      updatedState.qualificationStatus.age = userInput.toLowerCase() === 'yes';
      break;
    case 'income_requirement':
      updatedState.qualificationStatus.income = userInput.toLowerCase() === 'yes';
      break;
    case 'eviction':
      updatedState.qualificationStatus.eviction = userInput.toLowerCase() === 'yes';
      break;
    default:
