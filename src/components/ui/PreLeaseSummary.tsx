...
const PreLeaseSummary: React.FC<PreLeaseSummaryProps> = ({
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://lh3.googleusercontent.com/44QJS-Cl0QQLTNCVjqJ6VH-tFLwLbqhkyb_qLtYoxa0v1JblFPFMK0Xe7W8cWcKTbqoIZATYnAdWDkZte6jBDPQph9Mgb3HM9vs0yD2n=s3000-rw')", // ← Replace with actual path
      ...
      <div className="relative z-10 flex flex-col justify-between p-8 h-full overflow-y-auto">
        <div className="space-y-6">
          ...
          <div className="space-y-3 text-gray-700 text-sm">
            ...
            <div>
              <strong>Apartment Size:</strong> {apartmentSize}
            </div>
            <div>
              <strong>Income Meets Requirement:</strong> {incomeQualified ? '✅ Yes' : '❌ No'}
            </div>
            <div>
              <strong>Prior Evictions:</strong> {evictionStatus ? '❌ Yes' : '✅ No'}
            </div>
          </div>
        </div>
            ...
            (showTourCTA ? (
              <>
                <p className="text-center text-green-600 font-semibold">
                  🚀 Schedule your tour now and save <span className="text-blue-600">$50 off</span>{' '}
